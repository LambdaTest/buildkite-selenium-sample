# Run Selenium Tests with Buildkite CI on TestMu AI (Formerly LambdaTest)
...
```bash
git clone https://github.com/LambdaTest/buildkite-selenium-sample && cd buildkite-selenium-sample
